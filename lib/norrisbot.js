...
NorrisBot.prototype._onStart = function () {
    ...
    try {
      ...
      if (err) console.log("Unable to read from " + self.cwars.paths.settingsJSON + ". Run `codewars setup` first.")
...
NorrisBot.prototype._processCodeWars = function(originalMessage) {
    ...
    if (self.cwars.codeWarsState = "init" && originalMessage.text.indexOf("codewars setup") != 0) {
