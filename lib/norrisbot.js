...
NorrisBot.prototype._processCodeWars = function(originalMessage) {
    ...
    if (originalMessage.text.split("|")[2].toLowerCase().indexOf('codewars verify') > -1) {
        console.log("works!");
    } else {
        console.log("~~~~~~~~~~~~~~~~~~~~~~" + originalMessage.text.split("|")[2].toLowerCase().indexOf('codewars verify'))
    }
 ...
 * @private
 */
NorrisBot.prototype._isFileShare = function (message) {
    return message.type === 'message' && Boolean(message.text);
};
