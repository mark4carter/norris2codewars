...
NorrisCodeWars.inputSettings = function(settings) {
...
NorrisBot.prototype._testCodeWars = function(originalMessage) {
    ...
    console.log(self.cwars);
    console.log(self.cwars.bot);

    var channel = self._getChannelById(originalMessage.channel);
    // self.postMessageToChannel(channel.name, "'Testing connection ... ", {as_user: true});
...
NorrisBot.prototype._getCodeWars = function(settings) {
    ...
    NorrisCodeWars.inputSettings(settings);
...
[ ] Is CodeWars heirarchy correct?

[ ] Codewars Train has suddenly stopped working

[ ] How to transfer verify script to server
