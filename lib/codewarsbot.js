...
CodeWarsBot.prototype._loadBotUser = function () {
    var self = this;
 ...
 * @private
 */
CodeWarsBot.prototype._isCodeWars = function(message) {    
 ...
 * @private
 */
CodeWarsBot.prototype._processCodeWars = function(originalMessage) {
    var self = this;    
 ...
 * @private
 */
CodeWarsBot.prototype._testCodeWars = function(originalMessage) {
 ...
 * @private
 */
CodeWarsBot.prototype._trainCodewars = function(originalMessage) {
    var self = this;
 ...
 * @private
 */
CodeWarsBot.prototype._trainCodewarsYes = function(originalMessage) {
    var self = this;
 ...
 * @private
 */
CodeWarsBot.prototype._codewarsNo = function(originalMessage) {
    var self = this;
 ...
 *
 */
CodeWarsBot.prototype.debugger = function(originalMessage) {
 ...
 * @private
 */
CodeWarsBot.prototype._printCodeWars = function(originalMessage) {
    var self = this;
    var channel = this._getChannelById(originalMessage.channel);
 ...
 * 
 */
CodeWarsBot.prototype._codeWarsVerify = function(originalMessage) {
    ...
    this.cwars.attempt(msgArray).
        ...
        fail(function(err){
          console.log("fail " + err)
            self.postMessageToChannel(channel.name, "Send Failed : " + err, {as_user: true});
        })
        .catch(function (error) {
 ...
 * @private
 */
CodeWarsBot.prototype._submitCodeWars = function(originalMessage) {
 ...
 * @private
 */
CodeWarsBot.prototype._codewarsUnknown = function(originalMessage) {
    var self = this;
    var channel = this._getChannelById(originalMessage.channel);
 ...
 * @private
 */
CodeWarsBot.prototype._codewarsHelp = function(originalMessage) {
    var self = this;
    var channel = this._getChannelById(originalMessage.channel);
 ...
 * @private
 */
CodeWarsBot.prototype._getCodeWars = function(settings) {

    NorrisCodeWars.syncBot(this);
 ...
 * @private
 */
CodeWarsBot.prototype._processFileShare = function (message) {
 ...
 * @private
 */
CodeWarsBot.prototype._codewarsSetup = function(message) {
...
CodeWarsBot.prototype._getUserById = function (userId) {
